...
export const woodTypeHints: Record<Quality, string> = {
  standard: "**Опция Стандарт** — естественный рисунок дерева, допустимы сучки. Живая текстура с характером.\n\n**Опция Премиум** — более однородная поверхность, минимум сучков. Ровная и аккуратная древесина.",
  premium: "**Опция Стандарт** — естественный рисунок дерева, допустимы сучки. Живая текстура с характером.\n\n**Опция Премиум** — более однородная поверхность, минимум сучков. Ровная и аккуратная древесина.",
};
